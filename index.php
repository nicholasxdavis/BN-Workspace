...
<head>
    ...
    <link rel="icon" href="https://nicholasxdavis.github.io/BN-db1/img/workspace_icon.png" type="image/png">
...
<body class="min-h-screen" x-data="{ 
    ...
    allIntegrations: [
        ...
        { name: 'Facebook', provider: 'facebook', icon: 'fab fa-facebook', color: '#1877F2', enabled: true, tool_url: './api/integrations/meta/index.html' },
        { name: 'Instagram', provider: 'instagram', icon: 'fab fa-instagram', color: '#E4405F', enabled: true, tool_url: './api/integrations/meta/index.html' },
